...
ggplot(melted_df, aes(y = judge, x = prop, fill = variable )) + geom_col()+ 
  annotate("text", x = -0.02, y = seq_along(judge_counts), label = judge_counts, vjust = 0.5, hjust = +0.7, size = 3) + scale_fill_manual(values = colors_sentences) +labs(title = "Dissecting Judges' Sentencing", x = "Proportion", y = "", subtitle = "Proportions are not constant!")
...
The next plot shows the proportions per years; for example, in 1915, 100% of sentences were not convicted (whole red bar). Here you can also see somewhat of a pattern in the years from 1920-1945. 
